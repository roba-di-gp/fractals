...
rx, ry = 0.09,0.06 #x and y zoom radii
...
def zoom(xp,yp,rx,ry):
    ...
    y = np.linspace(ext1[3],ext1[2],ny)

    escape = ship(x,y,nx,ny)
    ...
    #plt.imsave(fname=r'c:\users\gugli\desktop\roba\burningship_zoom.jpg',arr=escape.T,cmap=colormap,origin='lower')
